...
export default function PressTeam() {
  ...
  const [socialLinks, setSocialLinks] = useState<PressSocialLinks>({
    facebook: "",
    instagram: "",
    twitter: "",
    youtube: "",
  ...
  useEffect(() => {
    ...
    getDoc(doc(db, "siteConfig", "press_social_links")).then((snap) => {
      if (snap.exists()) {
    ...
    <div className="min-h-screen bg-white">
      <div className="box-width">
        <div className="px-3 py-20 sm:px-10 lg:px-12 sm:py-24">
          ...
          {/* Social Media Links */}
          {(socialLinks.facebook || socialLinks.instagram || socialLinks.twitter || socialLinks.youtube || socialLinks.tiktok) && (
            <motion.div
              variants={fadeInVariants3}
              initial="initial"
              whileInView="animate"
