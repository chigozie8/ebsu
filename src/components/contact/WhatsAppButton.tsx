...
export const WhatsAppButton = () => {
  ...
  const phoneNumber = "2347082039150"; // Nigerian format with country code
  const message = "Hello! I need help with the FUTO PTE website.";
      ...
      <AnimatePresence>
        {isHovered && (
          <motion.div
            ...
            className="absolute right-16 top-1/2 -translate-y-1/2 bg-white px-3 py-2 rounded-lg shadow-lg whitespace-nowrap"
          >
