/**
 * Seed EBSU community groups into Firebase Firestore.
 * Run with: node scripts/seed-communities.mjs
 *
 * Requires VITE_FIREBASE_* env vars (or the hardcoded fallback config below).
 */
...
const firebaseConfig = {
  apiKey: process.env.VITE_FIREBASE_API_KEY || 'AIzaSyCeDJW_9r37phtogoo04FDUWcqEninfPfM',
  authDomain: process.env.VITE_FIREBASE_AUTH_DOMAIN || 'ebsumsa-f3120.firebaseapp.com',
  projectId: process.env.VITE_FIREBASE_PROJECT_ID || 'ebsumsa-f3120',
  storageBucket: process.env.VITE_FIREBASE_STORAGE_BUCKET || 'ebsumsa-f3120.firebasestorage.app',
  messagingSenderId: process.env.VITE_FIREBASE_MESSAGING_SENDER_ID || '1020501012962',
  appId: process.env.VITE_FIREBASE_APP_ID || '1:1020501012962:web:a5cfe29f53ad7aee9b89bb',
};
